...
//read file to data
XmlReaderOld::XmlReaderOld(std::string path, std::string targetTag)
{
    fileError = false;
...
void XmlReaderOld::readTagFromFile(std::string path, std::string targetTag)
{
    readPos = 0;
    data.clear();
...
std::vector<std::string> XmlReaderOld::getData()
{
    return data;
}

//returns an item in the data vector
std::string XmlReaderOld::getItem(int item)
{
    return data[item];
}

unsigned int XmlReaderOld::getSize()
{
    return data.size();
}
...
bool XmlReaderOld::getFileError(std::string path, std::string targetTag)
{
...
int XmlReaderOld::search1dVector(std::vector<std::string> & vectorBeingSearched, std::string target)
{
...
bool XmlReaderOld::findNextOfTag(std::string targetTag, std::string text)
{
...
std::string XmlReaderOld::removeTag(std::string text, std::string tag)
{
...
void XmlReaderOld::removeTagsFromData(std::string tag)
{
...
std::string XmlReaderOld::getFirstTag(std::string inputData)
{
    return inputData.substr(inputData.find("<") + 1, inputData.find(">") - 2);
}

std::string XmlReaderOld::stripOuterTag(std::string inputData)
{
...
bool XmlReaderOld::fileExists (const std::string& path)
{
  struct stat buffer;
...
std::string XmlReaderOld::readFileToString(std::string path)
{
    std::ifstream file;
    std::string text;
...
std::vector<std::string> XmlReaderOld::getError()
{
    return errorLog;
}

void XmlReaderOld::setError(std::string error)
{
    errorLog.push_back(error);
}

bool XmlReaderOld::isError()
{
    return fileError;
}
...
std::vector<std::vector<std::vector<std::string> > >XmlReaderOld::getSceneInfo(std::string inputData)
{
    bool processing = true;
    readPos = 0;
 ...
 */
std::vector<std::vector<std::string> > XmlReaderOld::getTagsAndData(std::string inputData)
{
    bool processing = true;
    int readPos = 0;
...
void XmlReaderOld::sortAttributes(std::vector<std::vector<std::string> > & item)
{
    int minIndex;
    std::string minValue;
...
int XmlReaderOld::findAttribute(std::vector<std::vector<std::string> > & vectorBeingSearched, std::string target)
{
    int first, last, middle, position;
    bool found, noResult;
...
void XmlReaderOld::sortItems(std::string target, std::vector<std::vector<std::vector<std::string> > > & inputList)
{
    int minIndex;
    std::string minValue;
...
std::vector<int> XmlReaderOld::index3dListByTag(std::string target, std::vector<std::vector<std::vector<std::string> > > inputList)
{
...
int XmlReaderOld::indexSearch3d(std::vector<std::vector<std::vector<std::string> > > vectorBeingSearched, std::vector<int> index, std::string target)
{
    int first, last, middle, position;
    bool found, noResult;
